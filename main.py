...
def get_enhanced_recommendations(request: EnhancedRecommendationRequest):
    ...
    NOTE: This is DIFFERENT from /sync_trip and /get_itinerary:
    - /sync_trip: Syncs Firestore data to MongoDB and generates initial city recommendations for the user's trip
    - /get_itinerary: Returns the initial itinerary generated by /sync_trip
    - /get_enhanced_recommendations: Provides flexible recommendations based on any destination input (state/city/landmark)
    """
    user_id = request.userId
    trip_id = request.tripId
